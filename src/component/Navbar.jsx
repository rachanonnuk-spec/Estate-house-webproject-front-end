    ...
    <div className='absolute top-0 left-0 w-full z-10' >
        ...
        <div className='container mx-auto max-w-7xl flex justify-between items-center py-4 px-6 md:px-20 lg:px-32  bg-transparent'>
            ...
            <ul className='hidden md:flex gap-7 text-white'>
                <a href="#Header" className='cursor-pointer hover:text-grey-400 hover:underline'>Home</a>    
                <a href="#About" className='cursor-pointer hover:text-grey-400 hover:underline'>About</a>
                <a href="#Projects" className='cursor-pointer hover:text-grey-400 hover:underline'>Project</a>
                <a href="#Testimonials" className='cursor-pointer hover:text-grey-400 hover:underline'>Testimonials</a>
            </ul>
          {/* <button href="#Contact" className='hidden md:block bg-white px-8 py-2 rounded-xl hover:bg-blue-400'>Sign Up</button> */}
          <div className=''>
        <a href="#Contact" className= 'hidden md:block bg-white px-8 py-2 rounded-xl hover:bg-blue-400 hover:bg-blue-400'>Sign Up</a>
          </div>
