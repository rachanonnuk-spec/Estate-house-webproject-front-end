...
const Contact = () => {
    ...
    const [result, setResult] = React.useState("");
      ...
      const onSubmit = async (event) => {
        ...
        formData.append("access_key", "759afff5-a7ef-4a72-9e90-c7234f27f115");
  ...
  return (
    ...
    className='text-center p-6 py-20 lg:px-20 w-full overflow-hidden' id='Contact'>
        ...
        <p className='text-center text-gray-600 mb-12 max-w-80 mx-auto'>Ready to Make a Move? Let's Build Your Future Together</p>
